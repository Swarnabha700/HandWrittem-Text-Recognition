...
const SignIn = () => {
    return (
        <div className="mb-5 bg-gray-100 flex flex-col justify-center py-8 sm:px-6 lg:px-8">
            <div className="sm:mx-auto sm:w-full sm:max-w-md">
                ...
                <p className="mt-2 text-center text-sm text-gray-600 max-w">
                    Or
                    <NavLink to="/signup" className="mx-1 font-medium text-blue-600 hover:text-blue-500">
                        create an account
                    </NavLink>
                </p>
            </div>
